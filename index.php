			...
			<section id="service">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2 col-sm-4 col-xs-12 text-center wow animated zoomIn">
						...
						<div class="col-md-2 col-sm-4 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.6s">
							<div class="service-item">
								<div class="service-icon">
						...
						<div class="col-md-2 col-sm-4 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.9s">
							<div class="service-item">
								<div class="service-icon">
