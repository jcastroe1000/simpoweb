    ...
    <body id="body">
        ...
        <main class="site-content" role="main">
            <section id="who" class="who2 section">
                ...
                <div id="invalidPass" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body" style="text-align: center;padding:20px">
                                <h4>Las contraseñas no conciden</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal fade" id="user_exist" >
                    <div class="modal-dialog modal-sm" >
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p style="text-align: center">El correo electrónico, ya fue registrado</p>
                                <p style="text-align: center">Para continuar con el registro, ingresa otra cuenta de correo</p>
                            </div>
                            <div class="modal-footer">

                                <a href="index.php"><button type="button"  class="btn btn-danger">Cancelar</button></a>
                                <a href="registrar.php"><button type="button"  class="btn btn-success">Reintentar</button></a>
                ...
                <div class="benefits text-center">
                    <form id="create_user" name="create_user" class="form-horizontal form-label-left" style="padding-top: 40px" onSubmit="return validarPasswd()">
        ...
        <script>
         document.getElementById("telephone_contact").onkeypress = function(e) {
