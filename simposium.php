                                ...
                                <section id="projects">
                                    <ul id="thumbs" class="portfolio">
                                        <?php
                                            ...
                                            $res = $mysqli->query("SELECT id,nombre,resumen,ruta from registro_eventos where seccion= 'simposium' ");
                                            $mysqli->close();
                                        ...
                                        <!-- Item Project and Filter Name -->
                                          ...
                                          <li class="item-thumbs col-lg-3" data-id="id-0" data-type="web">
                                            ...
                                            <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="<?php echo utf8_decode($nombre) ?>" href="../simpoweb/administrator/gallery/album/simposium/<?php echo $row['ruta']?>">
                                                <span class="overlay-img"></span>
                                                <span class="overlay-img-thumb font-icon-plus"></span>
                                            </a>
                                            <!-- Thumb Image and Description -->
                                            <img src="../simpoweb/administrator/gallery/album/simposium/<?php echo $row['ruta']?>" 
