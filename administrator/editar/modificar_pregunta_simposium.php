...
<html lang="en">
    ...
    <body class="nav-md">
                    ...
                    <div class="row" style="padding-top: 6%">
                        <div class="col-md-12">
                            <div class="x_panel" style="padding-top: 3%" >
                             <div class="">
                                    <h2 style="text-align: center;color: black;font-size: 20px;" class="Sansation_Regular">MODIFICAR PREGUNTA FRECUENTE</h2>

                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content" style="padding-top: 3%">

                                    <form id="update_faq_simposium" name="update_faq_simposium"  class="form-horizontal form-label-left">
        ...
        <script src="../js/update/update_faq_simposium.js"></script>
        <!--progress bar-->
