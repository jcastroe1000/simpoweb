...
<html lang="en">
    ...
    <body class="nav-md">
                        ...
                        <div class="col-md-12">
                            <div class="col-sm-11 col-sm-offset-1 col-md-9 col-md-offset-3 col-lg-6 col-lg-offset-3 form-box" style="height: 100%" >
                                <div class="container kv-main">
                                    ...
                                    <form  id="update_image_bs" name="update_image_bs">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 FolksDecoon" for="first-name" style="color: black"> </label>
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" id="id_image_bs" name="id_image_bs"  value="<?php echo $id_image ?>" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                    </form>
        ...
        <script src="../js/update/update_image_bs.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
