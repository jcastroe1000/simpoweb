...
<html lang="en">
    ...
    <body class="nav-md">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body" style="text-align: center;padding:20px">
                                    <h3>El Simposium ha sido modificado exitosamente</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-sm-11 col-sm-offset-1 col-md-9 col-md-offset-3 col-lg-6 col-lg-offset-3 form-box" style="height: 100%" >
                                <form role="form" id="update_simposium" name="update_simposium" class="f1" style="margin-top: -15px;">
        ...
        <script src="../js/update/update_simposium.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
