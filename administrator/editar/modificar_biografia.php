...
if (isset($_GET['u'])):
    ...
    $res = $mysqli->query("SELECT * FROM biografia WHERE id =" . $_GET['u']);
    $row = $res->fetch_assoc();
...
<html lang="en">
    ...
    <body class="nav-md">
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        ...
                        <form role="form" id="update_biography" name="update_biography" class="f1" style="margin-top: -15px;">
                            <h3 style="text-align: center">Registrar Biografia</h3>
                           <fieldset style="display: block;width: 100%;padding-top: 10%" >
                                <div class="form-group col-md-4" style="display: inline-block;">
                                    <label class="etiquetas" for="f1-first-name">Nombre (s):</label>
                                    <input type="text" name="name" id="name" min="1" max="1000000"  class="f1-first-name form-control3" 
                                           id="f1-first-name" style="width: 100%" placeholder="Nombre"
                                           value="<?php echo utf8_encode($row['nombre'])?>">
                                </div>
                                <div class="form-group col-md-4" style="display: inline-block">
                                    <label class="etiquetas" for="f1-first-name">Apellido Paterno:</label>
                                    <input type="text" name="surname_p" id="surname_p" placeholder="Apellido Paterno" 
                                           class="f1-first-name form-control3" id="f1-first-name" style="width: 100%"
                                           value="<?php echo utf8_encode($row['apellido_p'])?>">
                                </div>
                                <div class="form-group col-md-4" style="display: inline-block;">
                                    <label class="etiquetas" for="f1-first-name">Apellido Materno:</label>
                                    <input type="text" name="surname_m" id="surname_m" placeholder="Apellido Materno" 
                                           class="f1-first-name form-control3" id="f1-first-name" style="width: 100%"
                                           value="<?php echo utf8_encode($row['apellido_m'])?>">
                                </div>
                                <div class="form-group">
                                    <label class="etiquetas" for="f1-last-name">Descripción:</label>
                                    <textarea name="review" id="review" placeholder="Descripción" style="height: 200px;width: 100%"
        ...
        <script src="../js/update/update_biography.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
