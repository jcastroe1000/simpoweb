...
<html lang="en">
    ...
    <body class="nav-md">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body" style="text-align: center;padding:20px">
                                    <h3>El Taller ha sido modificado exitosamente</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-sm-11 col-sm-offset-1 col-md-9 col-md-offset-3 col-lg-6 col-lg-offset-3 form-box" style="height: 100%" >
                                <form role="form" id="update_workshop" name="update_workshop" class="f1" style="margin-top: -15px;">
                                    <h3 style="text-align: center">Modificar Taller</h3>
                                    <div class="f1-steps">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group" style="width: 45%;display: inline-block;">
                                            ...
                                            value="<?php echo utf8_encode($row['costo']) ?>">
                                        </div>
                                        <div class="form-group" style="width: 45%;display: inline-block;float: right">
                                            ...
                                            class="f1-first-name form-control3" id="f1-first-name" style="width: 100%"
                                            value="<?php echo utf8_encode($row['lugares_disponibles']) ?>">
                                        </div>
                                        <div class="form-group">
        ...
        <script src="../js/update/update_workshop.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
