...
<html lang="en">
    ...
    <body class="nav-md">
                        ...
                        <div class="col-md-12">
                            <div class="col-sm-11 col-sm-offset-1 col-md-9 col-md-offset-3 col-lg-6 col-lg-offset-3 form-box" style="height: 100%" >
                                <div class="container kv-main">
                                    ...
                                    <form  id="update_image_biography" name="update_image_biography">
        ...
        <script src="../js/update/update_image_biography.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
                                ...
                                $("#file-1").fileinput({
                                    ...
                                    fileType: "any",
                                                    ...
                                                    'theme': 'fa',
                                                            ...
                                                            initialPreview: [
                                                                    "<?php echo $path = '../gallery/album/biography/' . $row['ruta']; ?> "

                                                            ],
                                                            initialPreviewConfig: [
                                                                    // {caption: "<?php echo $row['nombre']; ?> ", url: "{<?php echo $path = '../gallery/album/biography/' . $row['ruta']; ?> }", key: 1}
