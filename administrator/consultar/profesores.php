                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 style="text-align: justify;text-transform: uppercase;text-align: center;font-weight: bold"><strong ></strong><?php echo utf8_encode($row['nombre_materia']) ?></h5> 
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-info" data-orientation="next"><a href="../editar/modificar_materia.php?u=<?php echo $row['id'] ?>">Editar</a></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
