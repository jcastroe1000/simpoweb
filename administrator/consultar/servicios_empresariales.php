            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px" class="SourceSansPro-Bold">Servicios Empresariales Registrados</h2></div>

                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:0px;" class="Sansation_Regular"><a href="../crear/registrar_servicio_empresarial.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Registrar Servicio Empresarial</button></a></h2></div>
                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            $res = $mysqli->query("SELECT * from registro_eventos WHERE seccion='servicio_empresarial' ");
                                            $mysqli->close();
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                         <img  src="<?php echo $path = '../gallery/album/bs/' . $row['ruta']; ?> "  style="height: 300px; width: 300px" class="center-block">
                                                        
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="icon-ban-circle"></i>&nbsp;Cerrrar</button>
                                                        <a href="../editar/modificar_imagen_servicio_empresarial.php?u=<?php echo $row['id']?>&i=<?php echo $row ['ruta'];?>"><button type="button" class="btn btn-success"><i class="icon-ok"></i>Edtiar Imagen</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>    
