            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:40px;" class="Sansation_Regular"><a href="../crear/registrar_seminario.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Registrar Seminario</button></a></h2></div>
                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php
                                                        ...
                                                        error_reporting(E_ALL);
                                                        $res = $mysqli->query("SELECT nombre,duracion,modalidad,fecha_creacion,usuario from registro_eventos WHERE seccion='seminario' ");
                                                        $mysqli->close();
