            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px" class="SourceSansPro-Bold">Biografias Registrados</h2></div>

                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:0px;" class="Sansation_Regular"><a href="../crear/registrar_biografia.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Registrar Biografia</button></a></h2></div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                         <img  src="<?php echo $path = '../gallery/album/biography/' . $row['ruta']; ?> "  style="height: 300px; width: 300px" class="center-block">
                                                        
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="icon-ban-circle"></i>&nbsp;Cerrrar</button>
                                                        <a href="../editar/modificar_imagen_biografia.php?u=<?php echo $row['id']?>&i=<?php echo $row ['ruta'];?>"><button type="button" class="btn btn-success"><i class="icon-ok"></i>Edtiar Imagen</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="modal fade" id="<?php echo $row['id'] . 11 ?>" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" >
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="icon-ban-circle"></i>&nbsp;Cerrrar</button>
                                                        <a href="../delete/delete_biography.php?d=<?php echo $row['id'] ?>&f=<?php echo $row['ruta'] ?>"><button type="button" class="btn btn-success"><i class="icon-ok"></i>Aceptar</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 style="text-align: justify;text-transform: uppercase;text-align: center;font-weight: bold"><strong ></strong><?php echo utf8_encode($nombre) ?></h5> 
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-info" data-orientation="next"><a href="../editar/modificar_biografia.php?u=<?php echo $row['id'] ?>">Editar</a></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
