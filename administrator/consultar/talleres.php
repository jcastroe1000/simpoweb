            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px" class="Sansation_Regular">Talleres Registrados</h2></div>
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:40px;" class="Sansation_Regular"><a href="../crear/registrar_taller.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Registrar Taller</button></a></h2></div>
                        <div style="width: 50%" class="center-block">
                            ...
                            if ($m == 1) {
                                ...
                                $modal = '<div class="alert alert-success alert-dismissible " role="alert" style="text-align:center" id="ok">
                                            <strong style="font-weight: 900;">Bien! El taller ha sido eliminado exitosamente.</strong>
                        ...
                        <div class="row" style="margin-top: 2%;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="Sansation_Bold" style="color: black;text-align: center">Nombre del Taller</th>
                                    ...
                                    <tbody>
                                        ...
                                        $res = $mysqli->query("SELECT id,nombre,duracion,modalidad,fecha_creacion,usuario,ruta from registro_eventos WHERE seccion='taller' ");
                                        $mysqli->close();
