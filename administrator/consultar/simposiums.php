            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:40px;" class="Sansation_Regular"><a href="../crear/registrar_simposium.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Registrar Simposium</button></a></h2></div>
                        ...
                        <div class="row" style="margin-top: 2%;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="Sansation_Bold" style="color: black;text-align: center">Nombre del Simposium</th>
                                    ...
                                    <tbody>
                                        ...
                                        $res = $mysqli->query("SELECT id,nombre,duracion,modalidad,fecha_creacion,usuario,ruta from registro_eventos WHERE seccion='simposium' ");
                                        $mysqli->close();
