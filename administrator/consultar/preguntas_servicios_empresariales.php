            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px" class="Sansation_Regular">Preguntas Frecuentes Servicios Empresariales</h2></div>
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:40px;" class="Sansation_Regular"><a href="../crear/registrar_pregunta_servicios_empresariales.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Añadir Pregunta </button></a></h2></div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $res = $mysqli->query("SELECT id_faqs,question,answer from faqs WHERE category='servicio_empresarial'");
                                        $mysqli->close();
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="../editar/modificar_pregunta_servicio_empresarial.php?d=<?php echo $row['id_faqs'] ?>"><button type="button" class="btn btn-primary">Modificar</button></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="../delete/delete_se_faqs.php?d=<?php echo $row['id_faqs'] ?>"><button type="button" class="btn btn-success"><i class="icon-ok"></i>Aceptar</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
