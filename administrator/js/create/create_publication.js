$(function() {
  $('#create_publication').submit(function() {
    ...
    if (comprobar > 0) {
      ...
      if (imagen[0].type != "image/png" && imagen[0].type != "image/jpg" && imagen[0].type != "image/jpeg") {
        ...
        if (imagen[0].size > 1024 * 1024 * 2) {
          ...
          var formulario = $('#create_publication');
          var datos = formulario.serialize();
          var archivos = new FormData();
          var url = '../gallery/create_publication.php';
          ...
          $.ajax({
            ...
            success: function (data) {
                ...
                setTimeout(function () {
                    ...
                    $(location).attr('href', '../consultar/publicaciones.php');
                }, 12000);
            },
            error: function(data) {
