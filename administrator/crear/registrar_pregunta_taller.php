...
<html lang="en">
    ...
    <body class="nav-md">
                    ...
                    <div class="row" style="padding-top: 6%">
                        <div class="col-md-12">
                            <div class="x_panel" style="padding-top: 3%" >
                             <div class="">
                                    <h2 style="text-align: center;color: black;font-size: 20px;" class="Sansation_Regular">REGISTRAR PREGUNTA FRECUENTE  EN TALLERES</h2>

                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content" style="padding-top: 3%">

                                    <form id="create_ws_question" name="create_ws_question"  class="form-horizontal form-label-left">
        ...
        <script src="../js/create/create_workshop_faq.js" ></script>
        <!--progress bar-->
