...
<html lang="en">
    <head>
        ...
        <title>Sistema de Administración - Registrar Pregunta en Revista </title>
    ...
    <body class="nav-md">
                    ...
                    <div class="row" style="padding-top: 6%">
                        <div class="col-md-12">
                            <div class="x_panel" style="padding-top: 3%" >
                             <div class="">
                                    <h2 style="text-align: center;color: black;font-size: 20px;" class="Sansation_Regular">REGISTRAR PREGUNTA EN REVISTA</h2>

                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content" style="padding-top: 3%">

                                    <form id="create_magazine_question" name="create_magazine_question"  class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 ">
                                                <input type="hidden" id="category" name="category" value="revista" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
        ...
        <script src="../production/js/create_magazine_faq.js" ></script>
        <!--progress bar-->
