...
<html lang="en">
    ...
    <body class="nav-md">
        <div class="container body">
            <div class="main_container">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body" style="text-align: center;padding:20px">
                                    <h3>Biografia Registrada Exitosamente...</h3>
                                </div>
                            </div>
                        </div>
                    </div>
              ...
              <div class="col-md-12">
                        ...
                        <form role="form" id="create_biography" name="create_biography" class="f1" style="margin-top: -15px;">
                           ...
                           <fieldset style="display: block;width: 100%;padding-top: 10%" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="review" id="review" placeholder="Descripción" style="height: 150px;width: 100%"
        ...
        <script src="../js/fileinput.js" type="text/javascript"></script>
        <script src="../js/create/create_biography.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
