...
<html lang="en">
    ...
    <body class="nav-md">
                    ...
                    <div class="row" style="padding-top: 6%">
                        <div class="col-md-12">
                            <div class="x_panel" style="padding-top: 3%" >
                             <div class="">
                                    <h2 style="text-align: center;color: black;font-size: 20px;" class="Sansation_Regular">REGISTRAR PREGUNTA FRECUENTE  EN DIPLOMADOS</h2>
        ...
        <script src="../js/create/create_diplomat_faq.js" ></script>
        <!--progress bar-->
