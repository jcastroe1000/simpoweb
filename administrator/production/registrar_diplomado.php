...
<html lang="en">
    <head>
        ...
        <title>Registrar Diplomado</title>
                                    ...
                                    <form id="upload_diplomat" name="upload_diplomat"  class="form-horizontal form-label-left">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="diplomat_name" name="diplomat_name" class="form-control col-md-7 col-xs-12" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="file"  id="diplomat_image" name="diplomat_image" class="file" data-show-preview="false">              
                                            </div>
