...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <div class="container body">
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row"  style="padding-top: 1%">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="">
                                    <h2 style="text-align: center;color: black;font-size: 20px;" class="Sansation_Regular">REGISTRAR PREGUNTA DE SEMINARIO</h2>
            ...
            <script src="../production/js/create_seminar_faq.js" ></script>
