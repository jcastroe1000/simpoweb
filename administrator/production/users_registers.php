                    ...
                    <div class="">
                        <div class="page-title">
                            ...
                            <div class="title_right">
                                <div class="col-md-8 col-sm-8 col-xs-12 form-group pull-left top_search" style="margin-top: 6%">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="width: 100%">
                                                        ...
                                                        <td width="25%"><?php echo $row ['apellidos'] ?></td>
                                                        <td width="25%"><?php echo $row ['email'] ?></td>
                                                        <td width="12.5%"> 
                                                           <a href="detalles_usuario.html"> <button type="button" class="btn btn-info pull-right">
