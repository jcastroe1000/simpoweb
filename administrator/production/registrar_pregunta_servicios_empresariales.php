                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row"  style="padding-top: 1%">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="">
                                    <h2 style="text-align: center;color: black;font-size: 20px;" class="Sansation_Regular">REGISTRAR PREGUNTA SERVICIOS EMPRESARIALES</h2>

                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form id="create_business_service_question" name="create_business_service_question"  class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 ">
                                                <input type="hidden" id="category" nasetme="category" value="servicio_empresarial" class="form-control col-md-7 col-xs-12" 
                                                      >
                                            </div>
                                        </div>
