                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="Sansation_Bold" style="color: black;text-align: center"s>Apellido Paterno</th>
                                            <th class="Sansation_Bold" style="color: black;text-align: center"s>Apellido Materno</th>
                                    ...
                                    <tbody>
                                        <?php
                                                        ...
                                                        $res = $mysqli->query("SELECT nombre,apellido_paterno,apellido_materno,email from administrator");
                                                        $mysqli->close();
                                                        while ($row = $res->fetch_assoc()):
                                                            ?>
                                        <tr>
                                            <td class="Sans" style="color: #6E6E6E;text-align: center"><?php echo $row ['nombre'] ?></td>
                                            <td class="Sans" style="color: #6E6E6E;text-align: center"><?php echo $row ['apellido_paterno'] ?></td>
                                            <td class="Sans" style="color: #6E6E6E;text-align: center"><?php echo $row ['apellido_materno'] ?></td>
                                            <td class="Sans" style="color: #6E6E6E;text-align: center"><?php echo $row ['email'] ?></td>
                                            <td class="Sans" style="color: #FF0000;text-align: center">Cambiar Estado        <i class="fa fa-trash"></i></td>
