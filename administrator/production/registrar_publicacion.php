...
<html lang="en">
    ...
    <body class="nav-md">
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box" >
                        <form role="form" id="upload_diplomat" name="upload_diplomat" class="f1" style="margin-top: -35px;">
                            <h3 style="text-align: center">Registrar Publicación</h3>
                            <div class="f1-steps">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="etiquetas" for="f1-first-name">Inicio:</label>
                                    <input type="time" name="time_finish" id="time_finish" class="f1-first-name form-control3" id="f1-first-name" style="margin-left: 6%">
                                </div>
                                <div class="form-group">
        ...
        <script src="../production/js/fileinput.js" type="text/javascript"></script>
        <script src="../production/js/upload_diplomat.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
