<?php
    ...
    if ($_FILES['foto']['size'] <= 2097152) {
        ...
        $query1 = "INSERT INTO registro_eventos(nombre,dirigido, objetivo, duracion, modalidad,inicio,termino,costo,ruta,fecha_creacion) "
                . "VALUES ('$course_name', '$addressed', '$objetive', '$duration', '$modality', '$date_start', '$date_finish', '$cost', '$foto', '$creation_date')";
