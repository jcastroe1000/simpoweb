...
<html lang="en">
    ...
    <body class="nav-md">
            ...
            <div class="main_container">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body" style="text-align: center;padding:20px">
                                    <h3>Simposium Creado Exitosamente...</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="right_col" role="main">
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box" >
                        <form role="form" id="upload_simposium" name="upload_simposium" class="f1" style="margin-top: -35px;">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group ">
                                    <label class="etiquetas" for="f1-first-name">Termino:</label>
                                ...
                                <div class="form-group">
                                    <label class="etiquetas" for="f1-first-name">Inicio:</label>
                                    <input type="time" name="time_start"  min="07:00" max="21:30" id="time_start" placeholder="Nombre" class="f1-first-name form-control3" id="f1-first-name" style="margin-left: 6%">
                                </div>
                                <div class="form-group">
                                    <label class="etiquetas" for="f1-first-name">Termino:</label>
                                    <input type="time" name="time_finish" id="time_finish" min="07:00" max="21:30" placeholder="Nombre" class="f1-first-name form-control3" id="f1-first-name" style="margin-left: 6%">
                                </div>
                                <div class="form-group">
        ...
        <script src="../production/js/fileinput.js" type="text/javascript"></script>
        <script src="../production/js/upload_simposium.js"></script>
        <!-- bootstrap-progressbar -->
        <script src="../vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
        <!-- Flot -->
