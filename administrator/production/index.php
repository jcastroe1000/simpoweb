                                        ...
                                        <div class="tile_count">
                                            <div class="animated flipInY col-lg-5 col-md-5 col-sm-5 col-xs-5 ">
                                                <div class="tile-stats">
                                                    ...
                                                    <br>
                                                    <h3 style="color: #000">Total de Usuarios</h3>
                                            ...
                                            <div class="tile_count">
                                                <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="tile-stats">
                                                        ...
                                                        <div class="count">179</div>
                                                        <br>
                                                        <h3 style="color: black">Total Simposiums</h3>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tile_count">
                                                <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="tile-stats">
                                                        ...
                                                        <div class="count">179</div>
                                                        <br>
                                                        <h3  style="color: #000">Usuarios Totales</h3>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tile_count">
                                            <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="tile-stats">
                                                    ...
                                                    <div class="count">179</div>
                                                    <br>
                                                    <h3  style="color: #000">Cursos Totales</h3>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tile_count">
                                            <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="tile-stats">
                                                    ...
                                                    <div class="count">179</div>
                                                    <br>
                                                    <h3  style="color: #000">Usarios Totales</h3>
                                                </div>
                                            </div>
