            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px" class="Sansation_Regular">Preguntas de Revista</h2></div>
                        <div class="clearfix"><h2 style="text-align: center;color: black;font-size: 25px;padding-top:40px;" class="Sansation_Regular"><a href="registrar_pregunta_revista.php"><button type="button"  class="btn btn-success"><i class="fa fa-plus"></i> Añadir Pregunta de Revista</button></a></h2></div>
