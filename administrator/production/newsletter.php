                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="Sansation_Bold" style="color: black;text-align: center"s>Fecha de Registro</th>
                                            <th></th>
                                    ...
                                    <tbody>
                                        <?php
                                                        ...
                                                        $res = $mysqli->query("SELECT correo_electronico,seccion,fecha_registro FROM newsletter order by id DESC");
                                                        $mysqli->close();
                                                        while ($row = $res->fetch_assoc()):
                                                            ?>
                                        <tr>
                                            <td class="Sans" style="color: #6E6E6E;text-align: center"><?php echo $row ['correo_electronico'] ?></td>
                                            ...
                                            <td class="Sans" style="color: #6E6E6E;text-align: center"><?php 
                                                                                                        $date_2=$row ['fecha_registro'];
                                                                                                        $objeto_DateTime = date_create_from_format('Y-m-d', $date_2);
