            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i>Estadisticas<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
...
<!--              <div class="menu_section">
        ...
        <div class="right_col" role="main">
            <?php
                ...
                $res = $mysqli->query("SELECT COUNT(*) as total_users FROM user_register ");
                $row= mysqli_fetch_assoc($res);
                $total_users=$row['total_users'];
                $mysqli->close();
                
                $res = $mysqli2->query("SELECT COUNT(*) as total_hombres FROM user_register where gender= '1'  ");
                $row= mysqli_fetch_assoc($res);
                $total_h=$row['total_hombres'];
                $mysqli2->close();
                
                $res = $mysqli3->query("SELECT COUNT(*) as total_mujeres FROM user_register where gender= '2' ");
                $row= mysqli_fetch_assoc($res);
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Total Hombres </span>
              <div class="count"><?php echo $total_h?></div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
